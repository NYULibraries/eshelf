...
class PrimoTest < ActiveSupport::TestCase
  ...
  test "becomes external system" do
    ...
    assert_equal("rft.ulr_ver=Z39.88-2004&rft.ctx_ver=Z39.88-2004&rfr_id=info:sid/primo.exlibrisgroup.com:primo-nyu_aleph000980206&rft_id=urn:isbn:0878409998&rft_id=urn:isbn:9780878409990&rft.isbn=0878409998&rft.isbn=9780878409990&rft_val_fmlt=info:ofi/fmt:kev:mtx:book&rft.genre=book&rft.date=c2003&rft.date=2003&rft.btitle=Virtual+inequality+%3A+beyond+the+digital+divide&rft.au=Karen+Mossberger&rft.contributor=Caroline+J+Tolbert&rft.contributor=Mary+Stansbury+1957-&rft.publisher=Georgetown+University+Press&rft.place=Washington%2C+D.C.&rft.tpages=192&rft_id=urn:isbn:0878409998&rft_id=urn:isbn:9780878409990&rft.isbn=0878409998&rft.isbn=9780878409990&rft.subject=Digital+divide&rft.subject=Divide%2C+Digital&rft.subject=Global+digital+divide&rft.subject=GDD+%28Global+digital+divide%29&rft.subject=Digital+divide",
      @record.url)
  end
